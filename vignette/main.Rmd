...
RT_rstan_lmer <- stan_lmer(logRT ~ group*condition + (1|subject),
                           ...
                           contrasts = list(group = 'contr.sum',
                                            condition = 'contr.sum'),
                           prior_intercept = normal(.638, autoscale = FALSE),
                           prior = normal(location = sapply(RT_coef_priors, `[[`, "mean"),
                                          #scale = 5 * sapply(RT_coef_priors, `[[`, "sd"),
                                          autoscale = FALSE
                                          ),
                           sparse = TRUE,
                           seed = 124,
...
```{r RT_stan_lmer_informed-priors_display, dependson = 'RT_rstan_lmer_informed-priors_contrasts'}
